    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CharachtersId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Charachters", x => x.CharachtersId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FractionsId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fractions", x => x.FractionsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SettingId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharachtersId = table.Column<long>(type: "bigint", nullable: true),
                    FractionsId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Setting_Charachters_CharachtersId",
                        column: x => x.CharachtersId,
                        principalTable: "Charachters",
                        principalColumn: "CharachtersId");
                    table.ForeignKey(
                        name: "FK_Setting_Fractions_FractionsId",
                        column: x => x.FractionsId,
                        principalTable: "Fractions",
                        principalColumn: "FractionsId");
                    table.ForeignKey(
                        name: "FK_Setting_World_WorldId",
                        column: x => x.WorldId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingId = table.Column<long>(type: "bigint", nullable: true),
                    GenreId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Game_Setting_SettingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Setting_CharachtersId",
                table: "Setting",
                column: "CharachtersId");

            migrationBuilder.CreateIndex(
                name: "IX_Setting_FractionsId",
                table: "Setting",
                column: "FractionsId");

            migrationBuilder.CreateIndex(
                name: "IX_Setting_WorldId",
                table: "Setting",
                column: "WorldId");
        }
